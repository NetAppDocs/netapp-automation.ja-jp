...
* ダウンロードする必要があります https://console.netapp.com/automationHub["Azure NetApp Filesを使用したOracle"^] NetApp ConsoleWeb UI を介した自動化ソリューション。ソリューションはファイルとしてパッケージ化されています `na_oracle19c_deploy-master.zip`。
* 次の特性を持つLinux VM：
+
